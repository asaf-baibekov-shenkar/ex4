function highlight(elmnt, mode) {
	...
	var tagcolor = "#808080";
	var innerhtmlcolor = "white";
	var tagnamecolor = "#569CD6";
	var attributecolor = "#9CDCFE";
	var attributevaluecolor = "#CE9178";
	var attributeassignmentcolor = "#D4D4D4";
	var commentcolor = "#6B9955";
	...
	elmntObj.style.fontFamily = "Menlo, Monaco, 'Courier New', monospace";
	if (!lang) lang = "html";
	...
	function htmlMode(txt) {
		...
		while (rest.indexOf("&lt;") > -1) {
			...
			done += `<span style="color: ${innerhtmlcolor};">${rest.substring(0, startpos)}</span>`;
	...
	function tagMode(txt) {
		...
		result = done + rest;
		if (result.substring(4).charAt(0) == '/') {
			result = "<span style=color:" + tagcolor + ">&lt;/</span>" + result.substring(4).slice(1);
		} else {
	...
	function attributeValueMode(txt) {
		return "<span style=color:" + attributevaluecolor + ">" + '<span style="color:' + attributeassignmentcolor + '">=</span>' + txt.slice(1) + "</span>";
	}
